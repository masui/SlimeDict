...
class String
  ...
  def roma2hiragana
    @@rk.roma2hiragana(self)
  end

  def roma2katakana
    @@rk.roma2katakana(self)
  end

  def hiragana2roma
    @@rk.hiragana2roma(self)
  end

  def katakana2roma
    @@rk.katakana2roma(self)
  end
end
...
#  rk = Romakana.new
  ...
  puts rk.katakana2roma('オモシロカッ')
  puts rk.katakana2roma('カャス')
  puts rk.katakana2roma('カッテ')
  puts rk.katakana2roma('カッナ')
  puts rk.katakana2roma('カゥナ')
  puts rk.katakana2roma('コンヤ')
  puts rk.katakana2roma('コンニャク')
  puts rk.roma2katakana(rk.katakana2roma('カゥナ')[0])
  puts rk.roma2katakana(rk.katakana2roma('コンヤ')[0])
  puts rk.roma2katakana(rk.katakana2roma('コンヤ')[1])
  puts rk.katakana2roma('キャレット')
  puts rk.katakana2roma('ショウジョウジ')
#  puts rk.katakana2roma('ヴァイオリン')
#  puts rk.hiragana2roma('う゛ぁいう゛ぁい')
#  puts rk.katakana2roma('ヴァイヴ')
#  puts rk.katakana2roma('ヴァイブ')
#  puts rk.roma2hiragana('vaivu')
#  puts rk.roma2katakana('vaivu')
#  puts rk.hiragana2roma("じしょ")
end
